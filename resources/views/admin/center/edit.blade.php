    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <div class="card card-custom">
                ...
                <form class="form" action="{{ route('admin.center-update',['id' => $center->id] )}}" method="POST"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input class="form-control" name="name" type="text" value="{{$center->name}}"
                                       id="name" required/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input class="form-control" name="address" type="text" value="{{$center->address}}"
                                       id="address" required/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input class="form-control" name="google_map_link" type="text"
                                       value="{{$center->google_map_link}}"
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="custom-file">
                                ...
                                <img src="{{ asset("$center->image") }}" height="100px" width="150px" alt="image">
                            </div>
                        ...
                        <div class="form-group mb-1">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3"
                                      required>{{$center->description}}</textarea>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-3">
                                <span class="switch">
                                    <label>
                                        <input type="checkbox" name="food_status" {{ $center->food_status == '1' ? 'checked' : '' }} />
                                        <span></span>
                                    </label>
                                </span>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="time"
                                       ...
                                       value="{{$center->open_time}}" required
                                />
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="time"
                                       ...
                                       value="{{$center->close_time}}" required
                                />
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="number" value="{{$center_ordinary->seat_number}}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="number" value="{{$center_ordinary->price}}"
                        ...
                        <div class="form-group mb-1">
                            ...
                            <textarea class="ckeditor form-control" id="editor" rows="3"
                                      name="ordinary_computer_performance">
                                {{ $center_ordinary->computer_performance }}
                            </textarea>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="number" value="{{$center_vip->room_number ?? null}}"
                                       id="vip_room_number"
                        ...
                        <div class="form-group row">
                            <label for="vip_room_seat_number" class="col-2 col-form-label">VIP өрөөний суудлын
                                тоо</label>
                            <div class="col-10">
                                <input class="form-control" type="number" value="{{$center_vip->seat_number ?? null}}"
                        ...
                        <div class="form-group row">
                            <label for="vip_room_seat_price" class="col-2 col-form-label">VIP өрөөний суудлын
                                үнэ</label>
                            <div class="col-10">
                                <input class="form-control" type="number" value="{{$center_vip->price ?? null}}"
                        ...
                        <div class="form-group mb-1">
                            ...
                            <textarea class="ckeditor form-control" id="editor_2" rows="3"
                                      name="vip_computer_performance">{{ $center_vip->computer_performance }}</textarea>
                        </div>
